...
class MathTest extends TestCase
{
    ...
    public function testMultiply()
    {
        ...
        $this->assertEquals(15.0, $this->sut->multiply(5.0,3.0));
        $this->assertEquals(6.0, $this->sut->multiply(2.0,3.0));        
    }

    public function testDivide()
    {
        $this->assertEquals(1.0, $this->sut->divide(2.0,2.0));
        $this->assertEquals(5.0, $this->sut->divide(15.0,3.0));
        $this->assertEquals(6.0, $this->sut->divide(36.0,6.0));        
    }
